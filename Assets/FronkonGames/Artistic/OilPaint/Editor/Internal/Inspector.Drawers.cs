...
namespace FronkonGames.Artistic.OilPaint
{
  ...
  public abstract partial class Inspector : VolumeComponentEditor
  {
    ...
    protected void DrawToggleWithReset(string name, string label = null)
    {
      SerializedDataParameter parameter = UnpackParameter(name);
      if (parameter == null)
        return;

      ToggleWithResetAttribute attr = parameter.GetAttribute<ToggleWithResetAttribute>();

      GUIContent displayLabel = new(label ?? parameter.displayName, attr?.tooltip ?? string.Empty);
      ...
      EditorGUILayout.BeginHorizontal();
      {
        ...
        EditorGUILayout.BeginHorizontal();
        {
          ...
          // Reset button
          bool defaultValue = attr?.value ?? default;
          if (ResetButton(defaultValue, value != defaultValue) == true)
            value = defaultValue;
      ...
      EditorGUILayout.BeginVertical();
      {
        EditorGUILayout.BeginHorizontal();
        {
          ...
          EditorGUILayout.BeginHorizontal();
          {
            ...
            // Reset button
            Vector3 resetValue = attr?.value ?? defaultValue;
      ...
      EditorGUILayout.BeginVertical();
      {
        EditorGUILayout.BeginHorizontal();
        {
          ...
          EditorGUILayout.BeginHorizontal();
          {
            ...
            // Reset button
            Vector4 resetValue = attr?.value ?? defaultValue;
            if (ResetButton(resetValue, value != resetValue) == true)
              value = resetValue;
        ...
        vecValue.y = EditorGUILayout.Slider("Y", vecValue.y, attr.min, attr.max);
        vecValue.z = EditorGUILayout.Slider("Z", vecValue.z, attr.min, attr.max);
        vecValue.w = EditorGUILayout.Slider("W", vecValue.w, attr.min, attr.max);
        if (EditorGUI.EndChangeCheck() == true)
    ...
    protected void DrawColorWithReset(string name, string label = null, Color defaultValue = default)
    {
      ...
      ColorWithResetAttribute attr = parameter.GetAttribute<ColorWithResetAttribute>();
      GUIContent displayLabel = new(label ?? parameter.displayName, attr?.tooltip ?? string.Empty);
      ...
      EditorGUILayout.BeginHorizontal();
      {
        ...
        EditorGUILayout.BeginHorizontal();
        {
          ...
          // Reset button
          Color resetValue = attr != null ? attr.color : defaultValue;
          if (ResetButton(resetValue, value != resetValue) == true)
            value = resetValue;
    ...
    /// <summary> Draws an CurveParameter with curve and reset. </summary>
    protected void DrawCurveWithReset(string name, string label = null, AnimationCurve defaultValue = null)
    {
      ...
      EditorGUILayout.BeginHorizontal();
      {
        ...
        EditorGUILayout.BeginHorizontal();
        {
          ...
          // Reset button
          if (ResetButton(defaultValue, true) == true && defaultValue != null)
