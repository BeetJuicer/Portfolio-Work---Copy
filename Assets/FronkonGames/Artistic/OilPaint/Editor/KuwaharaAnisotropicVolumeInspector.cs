...
{
  /// <summary> Kuwahara Anisotropic Volume inspector. </summary>
  [CustomEditor(typeof(KuwaharaAnisotropicVolume))]
  public sealed class KuwaharaAnisotropicVolumeInspector : Inspector
  {
    protected override string Description() => "Advanced adaptive filtering using elliptical regions for superior edge preservation";

    protected override void InspectorGUI()
    {
      KuwaharaAnisotropicVolume volume = (KuwaharaAnisotropicVolume)target;
      ...
      DrawIntSliderWithReset("blur", "Blur");
      DrawFloatSliderWithReset("sharpness", "Sharpness");
      DrawFloatSliderWithReset("hardness", "Hardness");
      DrawFloatSliderWithReset("alpha", "Alpha");
      DrawFloatSliderWithReset("zeroCrossing", "Zero crossing");
