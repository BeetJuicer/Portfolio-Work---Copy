...
{
  /// <summary> Kuwahara Basic Volume inspector. </summary>
  [CustomEditor(typeof(KuwaharaBasicVolume))]
  public sealed class KuwaharaBasicVolumeInspector : Inspector
  {
    protected override string Description() => "Standard edge-preserving smoothing using four sub-quadrants";

    protected override void InspectorGUI()
    {
      KuwaharaBasicVolume volume = (KuwaharaBasicVolume)target;
