...
{
  /// <summary> Symmetric Nearest Neighbor Volume inspector. </summary>
  [CustomEditor(typeof(SymmetricNearestNeighborVolume))]
  public sealed class SymmetricNearestNeighborVolumeInspector : Inspector
  {
    protected override string Description() => "Efficient smoothing by comparing symmetric pixel pairs around the center";

    protected override void InspectorGUI()
    {
      SymmetricNearestNeighborVolume volume = (SymmetricNearestNeighborVolume)target;
