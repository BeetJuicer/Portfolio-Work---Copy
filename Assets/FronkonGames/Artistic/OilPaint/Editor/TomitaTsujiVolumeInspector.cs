...
{
  /// <summary> Tomita-Tsuji Volume inspector. </summary>
  [CustomEditor(typeof(TomitaTsujiVolume))]
  public sealed class TomitaTsujiVolumeInspector : Inspector
  {
    protected override string Description() => "Alternative Kuwahara implementation using five sub-regions for better detail retention";

    protected override void InspectorGUI()
    {
      TomitaTsujiVolume volume = (TomitaTsujiVolume)target;
