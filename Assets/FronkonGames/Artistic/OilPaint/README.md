...
For better, more complete, and up-to-date documentation, please visit the [online help](https://fronkongames.github.io/store/artistic/).
...
2. Click **Add Renderer Feature** and select **Fronkon Games > Artistic > Oil Paint**.
...
3. Click **Add Override** and select **Fronkon Games > Artistic > Oil Paint**.
...
*   **Documentation:** [Online Help](https://fronkongames.github.io/store/artistic/)
