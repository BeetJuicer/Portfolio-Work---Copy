...
namespace FronkonGames.Artistic.OilPaint
{
  ...
  /// <summary> Vector4 with reset attribute. </summary>
  [AttributeUsage(AttributeTargets.Field)]
  public class Vector4SliderWithResetAttribute : PropertyAttribute
  {
    ...
    public Vector4SliderWithResetAttribute(float[] value, float min, float max, string tooltip = "")
    {
      this.value = new Vector4(value[0], value[1], value[2], value[3]);
      this.min = min;
      this.max = max;
      this.tooltip = tooltip;
    }
  ...
  {
    public EnumParameter() : base(default, false) { }
  ...
  {
    public Vector2IntParameter() : base(default, false) { }
    public Vector2IntParameter(Vector2Int value, bool overrideState = false) : base(value, overrideState) { }
  }

  /// <summary> Curve parameter. </summary>
  [Serializable]
  public class CurveParameter : VolumeParameter<AnimationCurve>
  {
    public CurveParameter() : base(new AnimationCurve(), false) { }
    public CurveParameter(AnimationCurve value, bool overrideState = false) : base(value, overrideState) { }
  }
}
