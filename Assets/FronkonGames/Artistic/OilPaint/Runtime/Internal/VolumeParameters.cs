...
namespace FronkonGames.Artistic.OilPaint
{
  ...
  [Serializable]
  public sealed class IntSliderParameterNoInterpolation : VolumeParameter<int>
  {
    public int min;
    public int max;

    public IntSliderParameterNoInterpolation(int value, int min, int max, bool overrideState = false)
      : base(value, overrideState)
    {
      this.min = min;
      this.max = max;
  ...
  /// <summary> Curve parameter with no interpolation. </summary>
  [Serializable]
  public sealed class CurveParameterNoInterpolation : VolumeParameter<AnimationCurve>
  {
    public CurveParameterNoInterpolation(AnimationCurve value, bool overrideState = false) : base(value, overrideState) { }
