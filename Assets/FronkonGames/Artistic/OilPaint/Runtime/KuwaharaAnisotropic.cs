...
namespace FronkonGames.Artistic.OilPaint
{
  ...
  public sealed class KuwaharaAnisotropic : ScriptableRendererFeature
  {
    ...
    private sealed class RenderPass : ScriptableRenderPass
    {
      ...
      private KuwaharaAnisotropicVolume volume;
      ...
      private void UpdateMaterial()
      {
        ...
        material.SetInt(ShaderIDs.Blur, volume.blur.value);
        material.SetFloat(ShaderIDs.Sharpness, volume.sharpness.value);
        material.SetFloat(ShaderIDs.Hardness, volume.hardness.value);
        material.SetFloat(ShaderIDs.Alpha, volume.alpha.value);
        material.SetFloat(ShaderIDs.ZeroCrossing, volume.zeroCrossing.value);
      ...
      {
        volume = VolumeManager.instance.stack.GetComponent<KuwaharaAnisotropicVolume>();
        ...
        using (var builder = renderGraph.AddRasterRenderPass<PassData>("OilPaintAnisotropicTensor", out var passData))
        {
