...
{
  /// <summary> Kuwahara Anisotropic Volume settings. </summary>
  [Serializable, VolumeComponentMenu("Fronkon Games/Artistic/Oil Paint/Kuwahara Anisotropic"), HelpURL(Constants.Support.Documentation)]
  public sealed class KuwaharaAnisotropicVolume : VolumeComponent, IPostProcessComponent
  {
    ...
    [IntSliderWithReset(2, 1, 6)]
    public IntSliderParameterNoInterpolation blur = new(2, 1, 6);

    /// <summary> Adjusts sharpness of the color segments [0, 18]. Default 8. </summary>
    [FloatSliderWithReset(8.0f, 0.0f, 18.0f)]
    public FloatSliderParameterNoInterpolation sharpness = new(8.0f, 0.0f, 18.0f);

    /// <summary> Adjusts hardness of the color segments [1, 100]. Default 8. </summary>
    [FloatSliderWithReset(8.0f, 1.0f, 100.0f)]
    public FloatSliderParameterNoInterpolation hardness = new(8.0f, 1.0f, 100.0f);

    /// <summary> How extreme the angle of the kernel is [0.01, 2]. Default 1. </summary>
    [FloatSliderWithReset(1.0f, 0.01f, 2.0f)]
    public FloatSliderParameterNoInterpolation alpha = new(1.0f, 0.01f, 2.0f);

    /// <summary> How much sectors overlap with each other [0.25, 2]. Default 0.58. </summary>
    [FloatSliderWithReset(0.58f, 0.25f, 2.0f)]
    public FloatSliderParameterNoInterpolation zeroCrossing = new(0.58f, 0.25f, 2.0f);
    ...
    public void Reset()
    {
      ...
      radius.value = 10;
      blur.value = 2;
      sharpness.value = 8.0f;
      hardness.value = 8.0f;
      alpha.value = 1.0f;
      zeroCrossing.value = 0.58f;
