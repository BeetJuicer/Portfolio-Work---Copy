...
{
  /// <summary> Kuwahara Directional Volume settings. </summary>
  [Serializable, VolumeComponentMenu("Fronkon Games/Artistic/Oil Paint/Kuwahara Directional"), HelpURL(Constants.Support.Documentation)]
  public sealed class KuwaharaDirectionalVolume : VolumeComponent, IPostProcessComponent
  {
