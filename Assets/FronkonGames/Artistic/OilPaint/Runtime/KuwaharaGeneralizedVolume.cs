...
{
  /// <summary> Kuwahara Generalized Volume settings. </summary>
  [Serializable, VolumeComponentMenu("Fronkon Games/Artistic/Oil Paint/Kuwahara Generalized"), HelpURL(Constants.Support.Documentation)]
  public sealed class KuwaharaGeneralizedVolume : VolumeComponent, IPostProcessComponent
  {
    /// <summary> Controls the intensity of the effect [0, 1]. Default 0. </summary>
    [FloatSliderWithReset(0.0f, 0.0f, 1.0f)]
    public FloatSliderParameterLinear intensity = new(0.0f, 0.0f, 1.0f);
