...
{
  /// <summary> Symmetric Nearest Neighbor Volume settings. </summary>
  [Serializable, VolumeComponentMenu("Fronkon Games/Artistic/Oil Paint/Symmetric Nearest Neighbor"), HelpURL(Constants.Support.Documentation)]
  public sealed class SymmetricNearestNeighborVolume : VolumeComponent, IPostProcessComponent
  {
