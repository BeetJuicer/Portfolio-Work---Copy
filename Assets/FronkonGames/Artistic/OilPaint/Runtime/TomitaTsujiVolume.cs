...
{
  /// <summary> Tomita-Tsuji Volume settings. </summary>
  [Serializable, VolumeComponentMenu("Fronkon Games/Artistic/Oil Paint/Tomita-Tsuji"), HelpURL(Constants.Support.Documentation)]
  public sealed class TomitaTsujiVolume : VolumeComponent, IPostProcessComponent
  {
