...
namespace FronkonGames.Artistic.OneBit.Editor
{
  ...
  public abstract partial class Inspector
  {
    ...
    /////////////////////////////////////////////////
    // Volume Parameter Drawer Methods
    /////////////////////////////////////////////////

    /// <summary> Draws a MinMaxSlider for two float parameters. </summary>
    protected void DrawMinMaxSliderWithReset(string minName, string maxName, string label, float minLimit, float maxLimit, float defaultMin, float defaultMax)
    {
      ...
      EditorGUILayout.BeginHorizontal();
      {
        ...
        if (ResetButton(defaultMin, defaultMin != minValue || defaultMax != maxValue) == true)
        {
          minValue = defaultMin;
          maxValue = defaultMax;
        }
