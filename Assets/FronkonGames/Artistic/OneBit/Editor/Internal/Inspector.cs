      ...
      BeginVertical();
      {
        ...
        if (styleLogo != null)
        {
          ...
          if (Foldout("Advanced") == true)
          {
            ...
            DrawToggleWithReset("useScaledTime", null, true);
            IndentLevel--;
          }
          ...
          BeginHorizontal();
          {
            ...
            {
              if (EditorUtility.DisplayDialog("Reset All Values", "Are you sure you want to reset all values to their defaults?", "Yes", "No") == true)
                ResetValues();
            }
          }
          EndHorizontal();
