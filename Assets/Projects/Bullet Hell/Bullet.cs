...
public class Bullet : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //Rotate direction by currentRotationSpeed
        //float currentRotationSpeed = bulletData.rotationSpeed * bulletData.rotationSpeedCurve.Evaluate(t);
        //float currentRotationSpeed = bulletData.rotationSpeed * Mathf.Sin(elapsed * 5f);
        //float angleInRadians = Mathf.Deg2Rad * currentRotationSpeed * Time.deltaTime;
